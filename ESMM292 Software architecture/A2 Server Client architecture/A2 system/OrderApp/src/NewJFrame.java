...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public void setUsrData(String aUsrName, String aDBURL)
    {
        jLabelUser.setText("Hello "+aUsrName);
        USER_NAME = aUsrName;
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (!connectError )
        {
            ...
            try
                {
                    SQLstatement = ( "INSERT INTO orders (order_date, order_creator, first_name, " +
                        "last_name, address, phone, total_cost, shipped) VALUES ( '" + dateTimeStamp + "', " +
                    ...
                    ResultSet res = null;
                   res = s.executeQuery( "SELECT MAX( ORDER_ID ) FROM orders" );
                   res.next();
        ...
        if ( !connectError && !executeError )
        {
            ...
            for (int i = 0; i < items.length; i++ )
            {
                ...
                if (orderItem.length() > 0 )
                {
                    ...
                    SQLstatement = ( "INSERT INTO orderDetails (product_id, description, item_price, orderId) " +
                        "VALUES ( '" + productID + "', " + "'" +
                        description + "', " + perUnitCost + ", '"+orderId+"' );");
                    try
                    {
                        executeUpdateVal = s.executeUpdate(SQLstatement);
          ...
          try
          {
            ...
            String dateTimeStamp = TheMonth + "/" + TheDay + "/" + TheYear + " "
              ...
              String logstm = ("INSERT INTO log (user_name, event, event_date)"+
                      "VALUES ('"+USER_NAME+"', 'logout', '" + dateTimeStamp + "' );");
                    s = DBConn.createStatement();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                LoginFrame fr = new LoginFrame(mainf);
                fr.setVisible(true);
