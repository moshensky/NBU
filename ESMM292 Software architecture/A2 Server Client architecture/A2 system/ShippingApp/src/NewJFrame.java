    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if ( !connectError && !orderBlank )
        {
            try
            {
                ...
                SQLStatement = "SELECT * FROM ORDERDETAILS where orderId=" + orderID;
                res = s.executeQuery( SQLStatement );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ( !connectError )
        {
            try
            {
                ...
                s = DBConn.createStatement();
                SQLStatement = "UPDATE orders SET shipped=" + true + ", shipped_date='"+dateTimeStamp+"' WHERE order_id=" + updateOrderID;
    ...
    private void getPendingOrders() {
        ...
        if ( !connectError )
        {
            try
            {
                ...
                s = DBConn.createStatement();
                res = s.executeQuery( "Select order_id, order_date, first_name, last_name, shipped from orders" );
                ...
                while (res.next())
                {
                    shippedStatus = Integer.parseInt(res.getString(5));
