...
public class WildPointsPressureFilter extends FilterFramework {
    ...
    public static final int MIN_VALID_PRESSURE = 45;
    public static final int MAX_VALID_PRESSURE = 90;

    public WildPointsPressureFilter(int outPorts) {
        super(outPorts);
    }
    ...
    private class Frame {
        ...
        Frame(long aTimeStamp, long aVelocity, long aAltitudeMeasure, long aPressureMeasure,
                long aTemperatureMeasure, long aAttitudeMeasure, long aExtrapolatedPressureMeasure) {
